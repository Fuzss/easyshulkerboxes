...
public class KeyBindingTogglesHandler {
    public static final KeyMapping TOGGLE_VISUAL_CONTENTS_KEY_MAPPING = new KeyMapping("key.toggleVisualTooltipContents", InputConstants.UNKNOWN.getValue(), "key.categories.misc");
    public static final KeyMapping TOGGLE_SELECTED_TOOLTIPS_KEY_MAPPING = new KeyMapping("key.toggleSelectedItemTooltips", InputConstants.UNKNOWN.getValue(), "key.categories.misc");
